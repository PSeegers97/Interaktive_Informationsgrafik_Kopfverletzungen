    ...
    <header class="header w-full flex flex-row justify-between h-1/8 items-center">
        ...
        <div class="mx-auto h-3/4">
            <div class="flex flex-row gap-32 h-full">
                ...
                <div class="flex flex-col gap-6 justify-center max-w-1/2">
                    <details class="">
                        <summary class="flex flex-row items-center gap-9"> 
                            <div class="w-35 flex flex-row justify-center">
                                <svg class="w-34 fill-[#edd9ce]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 446.73 307.71"><g id="c"><path d="M36.99,152.49c.32,18.62-.84,41.43-5.38,66.58-6.08,33.77-16.36,61.47-25.85,82.11,16.97-10.58,44.08-24.61,79.93-31.98,44.54-9.16,81.72-3.73,102.91,1.02h0c16.43,2.84,33.72,4.38,51.48,4.38,112.75,0,204.15-60.91,204.15-136.05S352.83,2.5,240.08,2.5,35.93,63.41,35.93,138.55c0,4.71.36,9.36,1.06,13.94Z" fill="#fff" stroke="#000" stroke-miterlimit="10" stroke-width="5"/></g></svg>
                            </div>
                        ...
                        <div class="pl-40">
                            <p class="">
                                Die Sportler:innen sollten angesprochen und es sollte auf ihre Reaktion geachtet werden. Beim Ansprechen sollte darauf geachtet werden, wie orientiert die Sportler:innen sind. 
                            </p>
                            <ul class="list-disc">
                                <li class="">Können sie genaue Sätze formulieren?</li> 
                                <li class="">Sind sie zeit- und räumlich orientiert?</li>
                                <li class="">Wissen sie, wo sie sich befinden und was in den letzten Sekunden passiert ist?</li>
                            </ul>
                            <p class="">Sollte eine Abweichung vom Normalverhalten auftreten, muss der/die Sportler:in aus dem aktiven Spielbetrieb entfernt werden.</p>
                            </div>
                    </details>
                    ...
                    <details class="group">
                        ...
                        <p class="pl-40">
                            Sportler:innen sind routiniert und zeigen bei einem Schädel-Hirn-Trauma abnormales Verhalten. Dieses Verhalten ist auf die Symptome zurückzuführen. Auch von außen sind einige Symptome sichtbar. Irrt ein:e Sportler:in auf dem Feld herum, ist dies eine Verhaltensauffälligkeit. Bei Verhaltensauffälligkeiten sollten die Sportler:innen erstmal zur Beobachtung aus dem aktiven Spielbetrieb genommen werden. 
                        </p>
                    </details>
                    ...
                    <details class="group">
                        ...
                        <p class="pl-40">
                            Der Kognitionstest CCT-3 befähigt Trainer:innen die Sportler:innen auf kognitive Einschränkungen zu testen. Am besten wäre es, wenn ein sogenannter Baseline-Test vor dem Beginn einer Spielzeit (Saison) durchgeführt wird. Somit sind Werte vorhanden, die klar die Abweichung zeigen können. 
                            Sollten Abweichungen auftreten, sollte der/die Sportler:in aus dem aktiven Spielbetrieb entfernt werden.    
                        </p>
                    </details>
                </div>
            </div>
